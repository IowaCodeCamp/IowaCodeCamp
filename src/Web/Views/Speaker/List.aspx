...
--%>
    ...
    <ul>
        ...
        <li id="AndrewPickett"><h3>Andrew Pickett</h3>()<p><img src="<%= SpeakerImageUrl("AndrewPickett.jpg") %>" align="left" /></p></li>
        ...
        <li id="BrentEdwards"><h3>Brent Edwards</h3>()<p><img src="<%= SpeakerImageUrl("BrentEdwards.jpg") %>" align="left" /></p></li>
        ...
        <li id="DarrenCauthon"><h3>Darren Cauthon</h3>()<p><img src="<%= SpeakerImageUrl("DarrenCauthon.jpg") %>" align="left" /></p></li>
        ...
        <li id="KirstinJuhl"><h3>Kirstin Juhl</h3>(Woodbury, MN)<p><img src="<%= SpeakerImageUrl("KirstinJuhl.jpg") %>" align="left" />will send via email</p></li>
        ...
        <li id="ScottDavis"><h3>Scott Davis</h3>(Mn)<p><img src="<%= SpeakerImageUrl("ScottDavis.jpg") %>" align="left" /></p></li>
