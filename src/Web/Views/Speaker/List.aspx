...
--%>
    ...
    <ul>
        ...
        <li id="AndrewPickett"><h3>Andrew Pickett</h3>(Minneapolis, MN)<p><img src="<%= SpeakerImageUrl("AndrewPickett.jpg") %>" align="left" />Andy Pickett - Codename: Snow Shadow - QONQR Co-Founder & Stealth Arctic Samurai.  Andy is a gamer at heart.  He bought his first Apple ][e at 14 and taught himself BASIC by hand coding game programs out of PC magazines, and was on his server's first Onyxia kill (non-WoW nerds please move along).  Professionally Andy has been a Software Developer, predominantly in the Microsoft space, for over 10 years.  He has lead a variety of successful development teams at major Retail, Financial, and State Government clients.  Andy is an avid Community Organizer and has a drive to help developers to master their craft.  He Co-Leads the Twin Cities .Net User Group and helps run local conferences like the Minnesota Developer's Conference and Twin Cities Code Camp. @apickett @qonqr</p></li>
        ...
        <li id="BrandonCarlson"><h3>Brandon Carlson</h3>(Madrid, IA)<p><img src="<%= SpeakerImageUrl("BrandonCarlson.jpg") %>" align="left" />Brandon is an IT leader at GeoLearning specializing in applying Lean thinking to software management. He has over a decade of experience as a developer and mentor and is a speaker at various IT events including the Iowa IIBA Developer Days, Agile 2008, Agile 2009, and a number of local user groups. Brandon can be found on Twitter (and most other sites such as GitHub and GoodReads) as 'bcarlso'.</p></li>
        <li id="BrentEdwards"><h3>Brent Edwards</h3>(Minneapolis, MN)<p><img src="<%= SpeakerImageUrl("BrentEdwards.jpg") %>" align="left" />Brent Edwards is a Senior Consultant for Magenic, a Microsoft Gold Partner consulting company. Brent has been knocking around the .NET world for over five years, working on projects ranging from ASP.NET MVC with C# and jQuery to WPF with VB.NET.  In his spare time, Brent develops applications for the Android platform.  His apps have over one million downloads and he was selected by Google as a Top Android Developer for their Device Seeding Program.  When not cranking out code, you can find him hanging out with his wife and three kids or riding his wakeboard, snowboard or mountain bike.</p></li>
        ...
        <li id="DarrenCauthon"><h3>Darren Cauthon</h3>(Olathe, KS)<p><img src="<%= SpeakerImageUrl("DarrenCauthon.jpg") %>" align="left" />Darren Cauthon (@darrencauthon) is an engineer with Digital Evolution Group, specializing in ecommerce, MVC, and TDD.  His passions include open-source development, TDD & SOLID evangelism, finding simpler ways to do what he does today, and philosophy.  He tests his code.</p></li>
        ...
        <li id="KirstinJuhl"><h3>Kirstin Juhl</h3>(Woodbury, MN)<p><img src="<%= SpeakerImageUrl("KirstinJuhl.jpg") %>" align="left" />Kirstin is a recovering engineer who re-discovered a passion for coding after an unfortunate encounter with FORTRAN in college. She attended computer camp at the age of 12 where they learned basic on Commodore 64s, and now loves attending and speaking at “grown-up computer camps”. Kirstin started writing software to support her processes as an engineer in 1996, and has been developing software full-time since 1999. She carries the process-orientated and problem-solving engineering traits into the world of software development where she “just wants to make things better.” Kirstin holds a B.S in Chemical Engineering from the University of Minnesota and an M.S.in Software Engineering from the University of St. Thomas. She lives in St. Paul, Minnesota with her husband and two children and recently finished the Des Moines marathon.</p></li>
        ...
        <li id="RalphBunker"><h3>Ralph Bunker</h3>(Fairfield, IA)<p><img src="<%= SpeakerImageUrl("RalphBunker.jpg") %>" align="left" />The email soliciting speakers for the code camp coincided exactly with my first non-trivial iPhone app starting to work. Since I am a world expert on what I had to go through to get the app to work, I thought that discussing my trials and tribulations would make a good talk. </p><p>I plan to start with opening the box that the Mac Pro came in and continue with the Mac environment, XCode, Interface Builder,  Objective C, the iPhone emulator, and getting permission from Apple to put the app on my iPod Touch. Essentially, I will try to cover things that I would have liked to known when I started and am very interested in meeting programmers who have developed iPhone apps.</p></li>
        ...
        <li id="ScottDavis"><h3>Scott Davis</h3>(Minneapolis, MN)<p><img src="<%= SpeakerImageUrl("ScottDavis.jpg") %>" align="left" />Scott Davis is a seasoned consultant with a decade of consulting experience on both the Microsoft and Java platforms. Scott began working with Silverlight in the 1.1 Alpha. Scott is the owner and principal consultant for Ignition Point Solutions. Recent projects for Scott include writing Silverlight 2.0 and Windows Mobile 6 applications, as well as executive-level IT strategy and planning consulting.  In addition to consulting full time, Scott is the leader of the Twin Cities Silverlight User Group, President of BizLounge Entrepreneurship Group, and an adjunct instructor at St. Mary’s University in the Information Technology Management masters program.</p></li>
