...
<asp:Content ID="Content3" ContentPlaceHolderID="primaryPH" runat="Server">
    <div id="sessions">
        <ul>
            ...
            <li><h3>Team Foundation Server Cool Tricks</h3><p>In this session we will walk-through a bunch of tips and tricks that I learned on the daily basis activities as a TFS user and administrator. Some of the topics include editing work item definitions (for good), customizing your process template and more.</p>
                    <dl><dt>Speaker</dt><dd><%= Html.SpeakerLink("Eduardo Bottcher") %></dd></dl></li>
