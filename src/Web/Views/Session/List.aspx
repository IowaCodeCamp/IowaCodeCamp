...
<asp:Content ID="Content3" ContentPlaceHolderID="primaryPH" runat="Server">
    <div id="sessions">
        <ul>
            ...
            <li><h3>State of Rest in .Net</h3><p>Topics covered: 5-minute ‘What is REST’: what, why and how. Examples creating RESTful services in MVC, Siesta and OpenRasta (in-depth on one method, quick demo of differences with others). Examples consuming RESTful services with framework classes, RestSharp, and ServiceStack.net (in-depth on one method, quick demo of differences with others). WCF REST Toolkit probably not covered (there’s only so much time you know)</p>
				<dl><dt>Speaker</dt><dd><%= Html.SpeakerLink("John Sheehan") %></dd></dl></li>
